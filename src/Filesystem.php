 ...
 */
abstract class Filesystem extends \CComponent
{
    /**
    ...
    public function init()
    {
        ...
        if ($this->cache !== null) {
            ...
            if (!$cache instanceof \CCache) {
                throw new \CException('The "cache" property must be an instance of \yii\caching\Cache subclasses.');
            }
        ...
        if ($this->replica !== null) {
            ...
            $filesystem = Yii::app()->getComponent($this->replica);

            if (!$filesystem instanceof Filesystem) {
                throw new \CException('The "replica" property must be an instance of \creocoder\flysystem\Filesystem subclasses.');
            }
